...
@if(app()->currentLocale() === 'ar' )
    ...
    <!--- Dark-mode css -->
    <link href="{{asset('assets_admin_dashboard/css-rtl/style-login-register.css')}}" rel="stylesheet">
    <!---Skinmodes css-->
...
@else
    ...
    <!--- Dark-mode css -->
    <link href="{{asset('assets_admin_dashboard/css/style-login-register.css')}}" rel="stylesheet">
    <!---Skinmodes css-->
